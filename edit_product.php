...
$del_query = "DELETE from product_to_technology WHERE product_id=".$product_id;
$conn->query($del_query); 
...
$del_query = "DELETE from product_milestones WHERE product_id=".$product_id;
$conn->query($del_query); 
...
$del_query = "DELETE from market_product WHERE product_id=".$product_id;
$conn->query($del_query);
...
$del_query = "DELETE from pipeline_product WHERE product_id=".$product_id;
$conn->query($del_query);
